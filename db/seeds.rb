...
ocean = Movie.create(
  title: "Ocean's Eight",
  overview: 'Debbie Ocean, a criminal mastermind, gathers a crew of female thieves to pull off the heist of the
  century.',
...
documentary = List.create!(name: 'Documentary')

Bookmark.create!(comment: 'Really amazing movie.', list: documentary, movie: ocean)
